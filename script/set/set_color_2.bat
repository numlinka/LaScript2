...
set color_0=%color_2%
if %ERRORLEVEL%==1 set color_2=0
if %ERRORLEVEL%==2 set color_2=1
if %ERRORLEVEL%==3 set color_2=2
if %ERRORLEVEL%==4 set color_2=3
if %ERRORLEVEL%==5 set color_2=4
if %ERRORLEVEL%==6 set color_2=5
if %ERRORLEVEL%==7 set color_2=6
if %ERRORLEVEL%==8 set color_2=7
if %ERRORLEVEL%==9 set color_2=8
if %ERRORLEVEL%==10 set color_2=9
if %ERRORLEVEL%==11 set color_2=a
if %ERRORLEVEL%==12 set color_2=b
if %ERRORLEVEL%==13 set color_2=c
if %ERRORLEVEL%==14 set color_2=d
if %ERRORLEVEL%==15 set color_2=e
if %ERRORLEVEL%==16 set color_2=f
if %ERRORLEVEL%==17 %site%script\set\set_color_1.bat
if %ERRORLEVEL%==18 goto set_color_0
if %ERRORLEVEL%==19 %site%script\set\set_main.bat
if %color_1%==%color_2% ( set color_2=%color_0% & goto set_color_2 )
